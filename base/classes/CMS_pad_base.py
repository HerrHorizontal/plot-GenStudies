...
class CMS_pad_base:
    ...
    def __init__(self, extraText = "Preliminary", cmsText="CMS", cmsTextFont=61, extraTextFont=52, lumiTextSize=0.6,
        lumiTextOffset=0.2, cmsTextSize=0.75, cmsTextOffset=0.1, hOffset=0, relPosX=0.045, relPosY=0.035, 
        relExtraDY=1.2, extraOverCmsTextSize=0.76, iPosX = 0, iPeriod = 4):
        ...
        self._canvas.SetLeftMargin(0.15)
        self._canvas.SetBottomMargin(0.15)
    ...
    def getLumiText(self, prefix = "", iPeriod = 4):
        lumiText = prefix
        if( iPeriod==1 ):
    ...
    def CMS_lumi(self, iPosX = 0, iPeriod=4, prefix = ""):
        ...
        lumiText = self.getLumiText(prefix = prefix, iPeriod = self._iPeriod)
