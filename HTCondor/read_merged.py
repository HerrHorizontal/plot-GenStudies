...
def getListOfEdges(chain, reference_chain, batchsize = 500000):
	'''
	...
	for iedge, edge in enumerate(edges):
		...
		with open(filename, 'wb') as scriptfile:
			...
			scriptfile.writelines(['# fill histo with batch number ' + str(batch) + '\n',
								   'cd ' + str(batchdir) + '\n'])
			scriptfile.writelines(['python ../../fill_merged_histo.py -n ' + batch + ' -l ' + str(edge[0]) + ' -u ' + str(edge[1]) + ' ' + datadir+"/"+os.path.basename(datadir) + '*.root\n'])
